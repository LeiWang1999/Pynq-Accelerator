...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { in_data_TVALID { I 1 bit } in_data_TDATA { I 8 vector } in_data_TREADY { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { out_data_TREADY { I 1 bit } out_data_TDATA { O 8 vector } out_data_TVALID { O 1 bit } } \
} "
} else {
