...
set id 9
set name cnn_sitofp_32ns_32_6_no_dsp_1
...
set id 11
set name cnn_sdiv_32ns_32ns_32_36_seq_1
...
set id 13
set name cnn_mul_32s_32s_32_2_1
...
set id 16
set name cnn_mul_32ns_32ns_64_2_1
set corename simcore_mul
set op mul
set stage_num 2
set max_latency -1
...
set id 17
set name cnn_mul_64ns_31ns_95_5_1
set corename simcore_mul
set op mul
set stage_num 5
set max_latency -1
...
set id 27
set name cnn_mul_mul_15s_15s_15_4_1
set corename simcore_mul
set op mul
set stage_num 4
set max_latency -1
...
set id 34
set name cnn_ama_addmuladd_15ns_15ns_15s_15s_15_4_1
...
set out_width 15
set exp (i0+i1)*i2+i3
set arg_lists {i0 {15 0 +} i1 {15 0 +} s {15 1 +} i2 {15 1 +} m {15 1 +} i3 {15 1 +} p {15 1 +} c_expval {c} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
...
set id 42
set name cnn_mac_muladd_15s_15s_15s_15_4_1
...
set out_width 15
set exp i0*i1+i2
set arg_lists {i0 {15 1 +} i1 {15 1 +} m {15 1 +} i2 {15 1 +} p {15 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { in_data_TDATA { I 8 vector } in_data_TVALID { I 1 bit } in_data_TREADY { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { out_data_TDATA { O 8 vector } out_data_TVALID { O 1 bit } out_data_TREADY { I 1 bit } } \
} "
} else {
